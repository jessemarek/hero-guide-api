    ...
    .then(function () {
      ...
      return knex('heroes').insert([
        ...
        },
        {
          ...
          position: 'mid',
          role: 'Middle Line DPS',
          description: 'Puts a curse on enemies that causes them to take Damage when they are close to other units with the same mark',
        ...
        },
        {
          ...
          position: 'mid',
          role: 'Middle Line DPS',
          description: 'Uses a variety of Magic Abilites dealing AoE or Single-Target Damage, with some abilities also having Slowing, Silencing or Armor-Reducing effects',
        ...
        },
        {
          ...
          position: 'back',
          role: 'Back Line DPS',
          description: 'Possesses powerful Single-Target Physical Attacks. Excels at eliminating enemies one-by-one by landing devastating Critical Hits',
          first_appeared: 'conjuring-stone',
          card_type: 3,
          chest_type: 'diamond',
        ...
        },
        {
          ...
          position: 'back',
          role: 'Back Line DPS',
          description: 'Uses lasers and missiles to bombard the enemy and deal Magic Damage. Excels at Single-Target Attacks',
          first_appeared: 'purchase-hero',
          card_type: 3,
          chest_type: 'diamond',
          available_in: 'hall-of-legends'
